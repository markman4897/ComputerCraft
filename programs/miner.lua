...
local function mineStep(down=false, up=false)
...
local function turn(down=false, up=false)
  if dir then
    ta.rotateRight()
...
local function mine(area)
  ...
  if not layer.down then ta.digDown()
  mineLayer(layer)
...
local function start()
  ...
  file.write("shell.run('programs/miner.lua')")
  files.close()
